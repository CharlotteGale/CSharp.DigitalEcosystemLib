...
public static class EcosystemDisplay
{
    private static ConsoleColor GetOrganismColor(IOrganism organism)
    {
        var baseType = organism.GetType().BaseType?.Name;
        return baseType == "Animal" ? ConsoleColor.Red : ConsoleColor.Green;
    }
    ...
    public static void AsHeirarcy(List<IOrganism> world)
    {
        ...
        {
            Console.ForegroundColor = GetOrganismColor(animal);
        ...
        {
            Console.ForegroundColor = GetOrganismColor(plant);
    ...
    public static void AsCircle(List<IOrganism> world)
    {
        ...
        for(int i = 0; i < world.Count; i++)
        {
            ...
            Console.ForegroundColor = GetOrganismColor(world[i]);
